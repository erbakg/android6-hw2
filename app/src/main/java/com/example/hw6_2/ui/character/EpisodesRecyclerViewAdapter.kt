...
import com.example.hw6_2.databinding.ItemEpisodeBinding
...
class EpisodesRecyclerViewAdapter :
    ...
    inner class EpisodeViewHolder(private val binding: ItemEpisodeBinding) :
        ...
        fun onBind(episode: Episode) {
            ...
            binding.apply {
                ("Season" + ' ' + seasonEpisode.first).apply {
                    tvSeasonNumber.text = this
                }
                ("Episode" + ' ' + seasonEpisode.second).apply {
